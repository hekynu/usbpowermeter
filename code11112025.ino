...
float ina219ScaleFactor = 10.0; // New shunt = 0.01Ω instead of 0.1Ω
...
void loadOff() {
  pinMode(CONTROL_PIN, INPUT); // High-Z → OFF
  loadState = false;
  updateLED();
...
void readINA219() {
  ...
  // Apply scaling for 0.01Ω shunt (10× smaller than 0.1Ω default)
